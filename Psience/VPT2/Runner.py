...
class VPTHamiltonianOptions:
    ...
    def __init__(self,
        ...
        all_opts = dict(
            ...
            cartesian_by_internal_derivative_method=cartesian_by_internal_derivative_method,
            expansion_handling_mode=expansion_handling_mode,
