...
## <a class="collapse-link" data-toggle="collapse" href="#Tests-5f7905" markdown="1"> Tests</a> <a class="float-right" data-toggle="collapse" href="#Tests-5f7905"><i class="fa fa-chevron-down"></i></a>
 </div>
 <div class="collapsible-section collapsible-section-body collapse show" id="Tests-5f7905" markdown="1">
...
- [AlignMoleculePermuteAtoms](#AlignMoleculePermuteAtoms)
- [AlignMoleculeNoPermuteAtoms](#AlignMoleculeNoPermuteAtoms)
- [AlignMoleculeIdentity](#AlignMoleculeIdentity)
...
<div class="collapsible-section">
 <div class="collapsible-section collapsible-section-header" markdown="1">
### <a class="collapse-link" data-toggle="collapse" href="#Setup-bfc105" markdown="1"> Setup</a> <a class="float-right" data-toggle="collapse" href="#Setup-bfc105"><i class="fa fa-chevron-down"></i></a>
 </div>
 <div class="collapsible-section collapsible-section-body collapse show" id="Setup-bfc105" markdown="1">
...
#### <a name="AlignMoleculePermuteAtoms">AlignMoleculePermuteAtoms</a>
```python
...
#### <a name="AlignMoleculeNoPermuteAtoms">AlignMoleculeNoPermuteAtoms</a>
```python
...
#### <a name="AlignMoleculeIdentity">AlignMoleculeIdentity</a>
```python
...
#### <a name="OrcaImport">OrcaImport</a>
```python
...
#### <a name="FormatImports">FormatImports</a>
```python
...
#### <a name="MACEEnergy">MACEEnergy</a>
```python
...
#### <a name="PartialSymmetries">PartialSymmetries</a>
```python
...
#### <a name="AtomTypeMap">AtomTypeMap</a>
```python
...
#### <a name="MoreBondZMatrix">MoreBondZMatrix</a>
```python
...
#### <a name="BreakBondZMat">BreakBondZMat</a>
```python
...
#### <a name="NeverEndingZMatrix">NeverEndingZMatrix</a>
```python
...
#### <a name="CanonicalZMatrix">CanonicalZMatrix</a>
```python
...
#### <a name="PubChemNames">PubChemNames</a>
```python
...
#### <a name="Functionalization">Functionalization</a>
```python
...
#### <a name="TrickyFunctionalization">TrickyFunctionalization</a>
```python
...
#### <a name="RestrictedZM2">RestrictedZM2</a>
```python
