...
<a id="Psience.VPT2.Analytic.PolyTerm.__new__" class="docs-object-method">&nbsp;</a> 
```python
@staticmethod
...
<a id="Psience.VPT2.Analytic.PolyTerm.order" class="docs-object-method">&nbsp;</a> 
```python
@property
order(self): 
```
...
<a id="Psience.VPT2.Analytic.PolyTerm.__hash__" class="docs-object-method">&nbsp;</a> 
```python
__hash__(self): 
```
<div class="docs-source-link" markdown="1">
...
<a id="Psience.VPT2.Analytic.PolyTerm.__eq__" class="docs-object-method">&nbsp;</a> 
```python
__eq__(self, other): 
```
<div class="docs-source-link" markdown="1">
...
<a id="Psience.VPT2.Analytic.PolyTerm.__reduce__" class="docs-object-method">&nbsp;</a> 
```python
__reduce__(self): 
```
<div class="docs-source-link" markdown="1">
...
[Bug](https://github.com/McCoyGroup/Psience/issues/new?title=Documentation%20Improvement%20Needed)/[Request](https://github.com/McCoyGroup/Psience/issues/new?title=Example%20Request)   
   ...
   <div class="col" markdown="1">
[Edit](https://github.com/McCoyGroup/Psience/edit/gh-pages/ci/examples/Psience/VPT2/Analytic/PolyTerm.md)/[New](https://github.com/McCoyGroup/Psience/new/gh-pages/?filename=ci/examples/Psience/VPT2/Analytic/PolyTerm.md)   
</div>
   <div class="col" markdown="1">
