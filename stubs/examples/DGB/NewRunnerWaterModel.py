"""Extracted from DGBTests.test_NewRunnerWaterModel via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest DGBTests.test_NewRunnerWaterModel"""
