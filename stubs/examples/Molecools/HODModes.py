"""Extracted from MolecoolsTests.test_HODModes via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest MolecoolsTests.test_HODModes"""
...
class MolecoolsTests(TestCase):
    ...
    def test_HODModes(self):
        ...
        self.assertEquals(tuple(np.round(modes.freqs * UnitsData.convert('Hartrees', 'Wavenumbers'))), (1422.0, 2810.0, 3874.0))
