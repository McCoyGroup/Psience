"""Extracted from MolecoolsTests.test_CanonicalZMatrix via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest MolecoolsTests.test_CanonicalZMatrix"""
...
class MolecoolsTests(TestCase):
    ...
    def test_CanonicalZMatrix(self):
        ...
        mol = Molecule.from_string(test_smi)
