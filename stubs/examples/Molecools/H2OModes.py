"""Extracted from MolecoolsTests.test_H2OModes via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest MolecoolsTests.test_H2OModes"""
...
class MolecoolsTests(TestCase):
    ...
    def test_H2OModes(self):
        ...
        self.assertEquals(tuple(np.round(modes.freqs * UnitsData.convert('Hartrees', 'Wavenumbers'))), (1622.0, 3803.0, 3938.0))
