"""Extracted from MolecoolsTests.test_ModeSelectedNMs via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest MolecoolsTests.test_ModeSelectedNMs"""
...
class MolecoolsTests(TestCase):
    ...
    def test_ModeSelectedNMs(self):
        ...
        loc_1 = modes.localize(internals=[(19, 8)])
        stretches = modes[tuple((t - 7 for t in [57, 58, 59, 60, 61, 62, 63]))]
        loc_2 = stretches.localize(internals=[(19, 8)])
