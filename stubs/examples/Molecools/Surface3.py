"""Extracted from MolecoolsTests.test_Surface3 via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest MolecoolsTests.test_Surface3"""
...
class MolecoolsTests(TestCase):
    ...
    def test_Surface3(self):
        ...
        surf = mol.get_surface(density=10).get_triangulation(grid_samples=50, method='isosurface', probe_radius=1)
