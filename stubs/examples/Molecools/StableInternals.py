"""Extracted from MolecoolsTests.test_StableInternals via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest MolecoolsTests.test_StableInternals"""
...
class MolecoolsTests(TestCase):
    ...
    def test_StableInternals(self):
        mol = Molecule.from_file('water_freq.fchk', internals=[[0, -1, -2, -3], [1, 0, -1, -2], [2, 0, 1, -1]])
