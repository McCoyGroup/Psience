"""Extracted from MolecoolsTests.test_PysisyphusZTSProfile via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest MolecoolsTests.test_PysisyphusZTSProfile"""
...
class MolecoolsTests(TestCase):
    ...
    def test_PysisyphusZTSProfile(self):
        ...
        prof = rxn.get_profile_generator('pys-string', energy_evaluator='aimnet2', climb=True)
