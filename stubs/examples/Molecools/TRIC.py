"""Extracted from MolecoolsTests.test_TRIC via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest MolecoolsTests.test_TRIC"""
...
class MolecoolsTests(TestCase):
    ...
    def test_TRIC(self):
        ...
        tr_react = react.modify(internals={'specs': [{'transrot': (0, 1, 2, 3)}, {'orientation': ((0, 1, 4), (2, 3, 5))}]})
