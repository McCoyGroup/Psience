"""Extracted from MolecoolsTests.test_TrickyFunctionalization via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest MolecoolsTests.test_TrickyFunctionalization"""
...
class MolecoolsTests(TestCase):
    ...
    def test_TrickyFunctionalization(self):
        ...
        new = base.attach_functional_group([targ], frag.atoms, frag.coords, frag.bonds, group_site=root)
        new.plot(backend='svg2d', highlight_atoms=[0, 1, 2]).show()
