"""Extracted from MolecoolsTests.test_SomeZMat3 via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest MolecoolsTests.test_SomeZMat3"""
...
class MolecoolsTests(TestCase):
    ...
    def test_SomeZMat3(self):
        ...
        int_mol.animate_coordinate(coordops.zmatrix_indices(int_mol.internals['zmatrix'], (9, 0, 1, 2)), 0.5, backend='x3d', highlight_atoms=int_mol.internals['zmatrix'][-4]).show()
