"""Extracted from MolecoolsTests.test_PySCFEnergy via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest MolecoolsTests.test_PySCFEnergy"""
...
class MolecoolsTests(TestCase):
    ...
    def test_PySCFEnergy(self):
        ethanol = Molecule.from_string('CCO', energy_evaluator=('pyscf', {'level_of_theory': 'b3lyp', 'basis_set': 'ccpvdz'}))
