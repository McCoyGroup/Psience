"""Extracted from MolecoolsTests.test_SubstructMatching via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest MolecoolsTests.test_SubstructMatching"""
...
class MolecoolsTests(TestCase):
    ...
    def test_SubstructMatching(self):
        ...
        match_tests = ['[N,n,O,o;H1:1]~[*:2]-[*;R0:3]=[*;R0:4]-[*:5]~[*:6]', '[N,n,O,o;H1:1]~[*:2]~[*:3]-[*;R0:4]=[*;R0:5]-[*:6]', '[N,n,O,o;H1:1]-[*;R0:2]=[*;R0:3]-[*:4]~[*:5]~[*:6]']
