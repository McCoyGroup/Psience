"""Extracted from MolecoolsTests.test_RequiredZMat2 via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest MolecoolsTests.test_RequiredZMat2"""
...
class MolecoolsTests(TestCase):
    ...
    def test_RequiredZMat2(self):
        ...
        zm = mol.get_bond_zmatrix(initial_backbone=[0, 2, 3, 1, 4, 5], required_coordinates=[(0, 2), (1, 3)])
        print(np.array(zm))
