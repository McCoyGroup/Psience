"""Extracted from MolecoolsTests.test_RMSDChecks via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest MolecoolsTests.test_RMSDChecks"""
...
class MolecoolsTests(TestCase):
    ...
    def test_RMSDChecks(self):
        ...
        print(nput.eckart_rmsd(traj[0].coords, traj[1].coords, masses=traj[0].masses, mass_weighted=True))
