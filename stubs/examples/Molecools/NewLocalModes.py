"""Extracted from MolecoolsTests.test_NewLocalModes via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest MolecoolsTests.test_NewLocalModes"""
...
class MolecoolsTests(TestCase):
    ...
    def test_NewLocalModes(self):
        ...
        locs = mol.get_normal_modes().localize(internals=[(0, 1), (0, 1, 2), (5, 4)], mass_weighted=True)
