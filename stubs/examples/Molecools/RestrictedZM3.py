"""Extracted from MolecoolsTests.test_RestrictedZM3 via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest MolecoolsTests.test_RestrictedZM3"""
...
class MolecoolsTests(TestCase):
    ...
    def test_RestrictedZM3(self):
        ...
        zm = fragged.get_bond_zmatrix(required_coordinates=[(0, 2), (1, 3)], initial_backbone=fragged.find_path(0, 1))
