"""Extracted from MolecoolsTests.test_InternalCoordOrder via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest MolecoolsTests.test_InternalCoordOrder"""
...
class MolecoolsTests(TestCase):
    ...
    def test_InternalCoordOrder(self):
        ...
        mol2.zmatrix = [[0, -1, -1, -1], [1, 0, -1, -1], [2, 1, 0, -1], [3, 2, 1, 0], [4, 3, 2, 0]]
