"""Extracted from MolecoolsTests.test_PysisyphusDimerProfile via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest MolecoolsTests.test_PysisyphusDimerProfile"""
...
class MolecoolsTests(TestCase):
    ...
    def test_PysisyphusDimerProfile(self):
        ...
        prof = rxn.get_profile_generator('pys-dimer', energy_evaluator='aimnet2', climb=True)
