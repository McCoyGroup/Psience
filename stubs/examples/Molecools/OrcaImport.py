"""Extracted from MolecoolsTests.test_OrcaImport via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest MolecoolsTests.test_OrcaImport"""
...
class MolecoolsTests(TestCase):
    ...
    def test_OrcaImport(self):
        propyl = Molecule.from_file(TestManager.test_data('proplybenz.hess'))
        print(propyl.get_normal_modes().freqs * UnitsData.hartrees_to_wavenumbers)
