"""Extracted from MolecoolsTests.test_AddDummyAtomProperties via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest MolecoolsTests.test_AddDummyAtomProperties"""
...
class MolecoolsTests(TestCase):
    ...
    def test_AddDummyAtomProperties(self):
        ...
        self.assertEquals(mol2.moments_of_inertia.tolist(), mol.moments_of_inertia.tolist())
        self.assertEquals(mol2.inertial_axes.tolist(), mol.inertial_axes.tolist())
