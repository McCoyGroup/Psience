"""Extracted from MolecoolsTests.test_FormatImports via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest MolecoolsTests.test_FormatImports"""
...
class MolecoolsTests(TestCase):
    ...
    def test_FormatImports(self):
        woof = Molecule.from_file(TestManager.test_data('water_dimer_freq_unopt.log'), 'gspec')
