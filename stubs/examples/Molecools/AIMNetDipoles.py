"""Extracted from MolecoolsTests.test_AIMNetDipoles via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest MolecoolsTests.test_AIMNetDipoles"""
...
class MolecoolsTests(TestCase):
    ...
    def test_AIMNetDipoles(self):
        water = Molecule(['O', 'H', 'H'], [[-3.09880964e-09, 0.123091261, 0.0], [-1.43810501, -0.976773835, 0.0], [1.43810505, -0.976773797, 0.0]], energy_evaluator='aimnet2', charge_evaluator='aimnet2', dipole_evaluator='aimnet2', polarizability_evaluator='aimnet2')
        print()
        ...
        return
        methanol = Molecule(['C', 'O', 'H', 'H', 'H', 'H'], [[-0.71174571, 0.0161939, 0.02050266], [1.71884591, -1.07310118, -0.2778059], [-1.30426891, 0.02589585, 1.99632677], [-0.77962613, 1.94036941, -0.7197672], [-2.02413643, -1.14525287, -1.05166036], [2.91548382, -0.08353621, 0.65084457]], energy_evaluator='aimnet2', dipole_evaluator='aimnet2')
