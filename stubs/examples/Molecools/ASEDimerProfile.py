"""Extracted from MolecoolsTests.test_ASEDimerProfile via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest MolecoolsTests.test_ASEDimerProfile"""
...
class MolecoolsTests(TestCase):
    ...
    def test_ASEDimerProfile(self):
        ...
        prof = rxn.get_profile_generator('ase-dimer', energy_evaluator='aimnet2', climb=True)
