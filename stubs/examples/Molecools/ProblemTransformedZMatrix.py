"""Extracted from MolecoolsTests.test_ProblemTransformedZMatrix via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest MolecoolsTests.test_ProblemTransformedZMatrix"""
...
class MolecoolsTests(TestCase):
    ...
    def test_ProblemTransformedZMatrix(self):
        ...
        int_react.animate_coordinate(pos, strip_embedding=True, draw_coords=[(2, 1)]).show()
