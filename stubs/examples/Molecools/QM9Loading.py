"""Extracted from MolecoolsTests.test_QM9Loading via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest MolecoolsTests.test_QM9Loading"""
...
class MolecoolsTests(TestCase):
    ...
    def test_QM9Loading(self):
        ...
        index = np.random.randint(130000)
