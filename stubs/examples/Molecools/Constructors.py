"""Extracted from MolecoolsTests.test_Constructors via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest MolecoolsTests.test_Constructors"""
...
class MolecoolsTests(TestCase):
    ...
    def test_Constructors(self):
        ...
        b = Molecule.construct([a.atoms, a.coords, dict(internals=[[0, -1, -1, -1], [1, 0, -1, -1], [2, 1, 0, -1], [3, 1, 0, 2]])])
