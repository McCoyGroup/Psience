"""Extracted from VPT2Tests.test_HOHVPTSubstates via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest VPT2Tests.test_HOHVPTSubstates"""
...
class VPT2Tests(TestCase):
    ...
    def test_HOHVPTSubstates(self):
        ...
        VPTRunner.run_simple(mol, [[0, 0, 0], [1, 0, 0]], order=2, expansion_order=2, logger=True)
