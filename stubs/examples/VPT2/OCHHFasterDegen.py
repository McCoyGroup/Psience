"""Extracted from VPT2Tests.test_OCHHFasterDegen via McUtils.Docs.ExamplesParser -- not the original file, and may reference test-only setup/state. Run with: python -m unittest VPT2Tests.test_OCHHFasterDegen"""
